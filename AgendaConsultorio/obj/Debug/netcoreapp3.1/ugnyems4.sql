...
CREATE TABLE [Tbl_Agenda] (
    ...
    CONSTRAINT [FK_Tbl_Agenda_Tbl_Paciente_BlogForeignKey] FOREIGN KEY ([BlogForeignKey]) REFERENCES [Tbl_Paciente] ([Cod_Paciente]) ON DELETE CASCADE
);

GO

CREATE INDEX [IX_Tbl_Agenda_BlogForeignKey] ON [Tbl_Agenda] ([BlogForeignKey]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220702005605_inicial', N'3.1.26');
