...
ADD CONSTRAINT FK_PACIENTE_ID FOREIGN KEY(PacienteID)
...
insert into Tbl_Agenda (CPF_Paciente_Agenda, PacienteID, Data_Consulta, Hora_Inicial, Hora_Final , DATA_Hora_Consulta) values (75060730050,1,'2022-12-12', '08:00:00', '09:00:00','2022-12-12 08:00:00');
